            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 mb-10">
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none text-center">{stats.usersLength}</p>
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white dark:text-gray-800">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none text-center">{stats.blogsLength}</p>
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white dark:text-gray-800">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none text-center">{stats.commentsLength}</p>
