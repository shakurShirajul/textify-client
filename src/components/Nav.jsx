      ...
      <div className="max-w-7xl mx-auto font-grotsk">
        <Navbar fluid rounded>
          ...
          <NavbarCollapse>
            ...
            >
              <span className={buttonStyle}>Home</span>
            </NavLink>
            <NavLink
              to="/addblog"
              className={({ isActive }) => isActive && activeButton}
            >
              <span className={buttonStyle}>Add Blog</span>
            </NavLink>
            <NavLink
              to="/allblogs"
              className={({ isActive }) => isActive && activeButton}
            >
              <span className={buttonStyle}>All Blog</span>
            </NavLink>
            <NavLink
              to="/featuredblog"
              className={({ isActive }) => isActive && activeButton}
            >
              <span className={buttonStyle}>Featured Blogs</span>{" "}
            </NavLink>
            <NavLink
              to="/mywishlist"
              className={({ isActive }) => isActive && activeButton}
            >
              <span className={buttonStyle}>Wishlist</span>
            </NavLink>
          </NavbarCollapse>
        </Navbar>
      </div>
