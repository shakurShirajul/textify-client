...
const Footer = () => {
    return (
        <div>
            <footer className="mt-20 px-4 divide-y bg-white dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <Link to='/' className="flex justify-center space-x-1 lg:justify-start">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
                                <img src="https://i.postimg.cc/pVkH0141/b6070a90-a827-4181-be10-97c3447275c9.png" className="w-30 h-30" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold font-grotsk">Textify</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        <div className="space-y-3">
                            <h3 className="tracking-wide uppercase font-semibold dark:text-gray-900">Product</h3>
