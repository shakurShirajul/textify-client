                ...
                <div className="space-y-2 md:space-y-0 md:flex justify-between gap-10">
                    ...
                    <div className="flex-1 flex items-center">
                        <div className="space-y-2 w-full">
                            <div class="mx-auto space-y-4 sm:flex sm:space-y-0 w-full">
                                ...
                                <div>
                                    <input type="button" class="py-3 px-5 w-full text-sm font-semibold text-center rounded-lg text-white border cursor-pointer bg-green-600 border-green-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-700 " value="Subscribe" />
                                </div>
                            </div>
