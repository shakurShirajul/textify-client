        ...
        <div className="flex flex-col justify-between leading-normal gap-2">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Link to={`/blogdetails/${_id}`} className="w-full">
              <button
                type="button"
                class="focus:outline-none text-white bg-green-600 hover:bg-green-800  font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 w-full"
              >
                View Details
              </button>
            </Link>
