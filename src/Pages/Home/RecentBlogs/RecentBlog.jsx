                ...
                <div className="border rounded-xl p-5 space-y-4 bg-white h-[590px]">
                    ...
                    <div className="flex flex-col justify-between leading-normal gap-4">
                        ...
                        <div className="flex justify-end gap-2">
                            <button onClick={handleWishListButton} type="button" className="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none ">Add to Wishlist</button>
                            <Link type="button"
                                to={`/blogdetails/${_id}`}
                                className="focus:outline-none text-white bg-green-600 hover:bg-green-800  font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 ">View Details</Link>
                        </div>
                    </div>
                </div>
            </div >
